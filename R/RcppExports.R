...
findNewDimKnot <- function(dcumFixedDim_Dim, Dim_weights, Dim_oldknots, Dim_values, residuals) {
    .Call('_GeDS_findNewDimKnot', PACKAGE = 'GeDS', dcumFixedDim_Dim, Dim_weights, Dim_oldknots, Dim_values, residuals)
}
